...
<body>
	<div class="container-scroller">
		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="main-panel">
				...
				<jsp:include page="../../user/same/same_footer.jsp"></jsp:include>
			</div>
		</div>
	<script type="text/javascript">
	var totalRecord;
	...
	function build_massages_table(result) {
		...
		$.each(massages,function(index, item) {
			...
			var btn_del = $("<button></button>").addClass("btn btn-inverse-primary btn-rounded btn-icon").attr("title","删除").attr("type","button").append($("<i><i>").addClass("mdi mdi-delete").attr("del-name", item.title).attr("del-id", item.id));
			var btn_read = $("<button></button>").addClass("btn btn-inverse-primary btn-rounded btn-icon").attr("title","标记为已读").attr("type","button").append($("<i><i>").addClass("mdi mdi-email-open").attr("read-id",item.id));
