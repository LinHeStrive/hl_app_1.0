...
public class CFBModle {
	public void CFB(String plaintext, String key) throws UnsupportedEncodingException {
		// 将明文转换为char
		...
		for (int i = 0; i < lenght; i = i + 16) {
			...
			//将前一轮密文作为下一轮的iv
			striv = String.valueOf(enplain);
		}
//		System.out.println("AES-------CFB模式加密产生的密文为：");
